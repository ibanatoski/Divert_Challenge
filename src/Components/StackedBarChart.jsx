...
class StackedBarChart extends Component {
  ...
  componentDidUpdate (prevProps, prevState){
    ...
    if(this.props.selectedStores && this.props.selectedStores.length > 0){
      ...
      this.renderStackedBar(this.props.selectedStores, "#select-data-bar");
    }
  }

  renderStackedBar(data, div_id){
    d3.select(`select-data-bar > svg`).remove();
    ...
    var keys = this.props.selectedStoresKeys;
    ...
    svg.append("g")
      ...
      .append("g")
      // .attr("fill", (d, i) => {
      //   return colorScale(stackedStores.keys[i])
      // })
      .selectAll("rect")
      .data((d) => d)
      .enter().append("rect")
        ...
        <div className="line-data">
          <div className="bottom-top">
            <div>
              <h3>Top 5</h3>
              {
                // (this.props.topData && this.props.topData.length > 0)?
                // this.renderLineGraph(this.props.topData, "#top-data-line")
                // : null
              }
              {
                (this.props.selectedStores && this.props.selectedStores.length > 0)?
                this.renderStackedBar(this.props.selectedStores, "#store-data-bar")
                : null
              }
            </div>
            ...
            <div>
              <h3>Bottom 5</h3>
              {
                // (this.props.bottomData && this.props.bottomData.length > 0)?
                // this.renderLineGraph(this.props.bottomData, "#bottom-data-line")
                // : null
              }
            </div>
